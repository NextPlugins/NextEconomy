...
public class ConvertorManager {
    ...
    protected final List<Convertor> convertors = new ArrayList<>();
    private final AccountRepository accountRepository;

    private boolean converting;
    private int actionBarTaskID;

    public Convertor getByName(String name) {
        return convertors.stream()
    ...
    public String availableConversors() {
        return convertors.stream()
                .map(Convertor::getConversorName)
    ...
    public boolean isAvailable(@Nullable CommandSender sender) {
