...
public final class NextEconomyCommand {
    ...
    public void onSwipeDataCommand(Context<CommandSender> context, String option) {
        ...
        if (!convertorManager.isAvailable(context.getSender())) return;
        ...
        convertorManager.setConverting(true);
    ...
    public void onConverterCommand(Context<CommandSender> context,
        ...
        val conversor = convertorManager.getByName(option);
        if (conversor == null) {
            context.sendMessage(ColorUtil.colored(
                    "&cConversor inválido, conversores válidos: " + convertorManager.availableConversors())
            );
            return;
        }
        ...
        if (accounts == null || accounts.isEmpty()) {
            ...
            convertorManager.setConverting(false);
            return;
        }
